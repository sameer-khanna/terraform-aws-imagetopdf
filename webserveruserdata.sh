...
#        listen       [::]:443 ssl http2;
#        server_name  _;
#        root         /var/www/testangularapp;location / {try_files $uri $uri/ /index.html;} location /api/ {proxy_pass http://api.internal-sameerkhanna.net/api;}resolver 10.0.0.2 valid=300s;
#
